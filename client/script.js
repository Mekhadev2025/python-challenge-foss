...
Explain the problem you found and how your corrected code addresses it.
  ...
  function runCode() {
    console.log('clicked');
    var codeData = document.getElementById("codeInput").innerText;
  ...
  //       'Content-Type': 'application/json'
  //     },
  //     body: JSON.stringify({ code: codeData }) // Send codeData as a JSON object
  //   })
  //   .then(response => response.text())
  //   .then(data => {
...
//   // Get the submitted code from the textarea
//   var submittedCode = document.getElementById("codeInput").value;

//   // Create a FormData object and append the code to it
//   var formData = new FormData();
//   formData.append("code", submittedCode);
...
//           // document.getElementById("opArea").innerText = output;
//       })
